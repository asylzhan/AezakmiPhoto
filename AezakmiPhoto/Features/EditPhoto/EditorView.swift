...
struct EditorView: View {
    ...
    init(media: MediaItem, onClose: @escaping () -> Void) {
        ...
        UIPickerView.appearance().backgroundColor = UIColor(red: 17.0/255.0, green: 16.0/255.0, blue: 14.0/255.0, alpha: 1.0)
        ...
        UISegmentedControl.appearance().backgroundColor = UIColor(red: 21.0/255.0, green: 21.0/255.0, blue: 17.0/255.0, alpha: 1.0) // visible as 44,44,44
        UISegmentedControl.appearance().selectedSegmentTintColor = UIColor(red: 244.0/255.0, green: 244.0/255.0, blue: 244.0/255.0, alpha: 1.0)
    }
